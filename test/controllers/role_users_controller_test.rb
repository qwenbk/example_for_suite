...
class RoleUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create role_user" do
    assert_difference('RoleUser.count') do
      post role_users_url, params: { role_user: { role_id: @role_user.role_id, user_id: @role_user.user_id } }
    end
  ...
  test "should update role_user" do
    patch role_user_url(@role_user), params: { role_user: { role_id: @role_user.role_id, user_id: @role_user.user_id } }

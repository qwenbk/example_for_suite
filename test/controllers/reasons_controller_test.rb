...
class ReasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reason" do
    assert_difference('Reason.count') do
      post reasons_url, params: { reason: { kind: @reason.kind, name: @reason.name, part_of_line_id: @reason.part_of_line_id, value: @reason.value } }
    end
  ...
  test "should update reason" do
    patch reason_url(@reason), params: { reason: { kind: @reason.kind, name: @reason.name, part_of_line_id: @reason.part_of_line_id, value: @reason.value } }
